...
function reducir(texto) {
  ...
  document.getElementById('principal').innerHTML = '<div id="contenedor_resultado"><div class="letra"><p class="txt-valor">' + 
	...
	vocales.o+ '</p><p class="txt-letra">Letter O</p></div><div class="letra"><p class="txt-valor">'+vocales.u+'</p><p class="txt-letra">Letter U</p>' +        
  	'</div><div class="letra"><p class="txt-valor">'+ texto.length +'</p><p class="txt-letra">Letter Total</p></div>';
}
